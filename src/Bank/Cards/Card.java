...
import Bank.System.FileDatabaseSystem;
...
public abstract class Card {
    ...
    public Card(String hashedCode, CardTypes cardType, double withdrawLimit, double transferLimit, double depositLimit, double transferLimitOwnAccount, double depositLimitOwnAccount) {
        cardNumber = generateRandom16DigitCardNumber(); // this is currently not unique. fix later when db is implemented; i mean make sure it doesnt already exist
    ...
    public static String generateRandom16DigitCardNumber() {
        long min = 1_000_000_000_000_000L;
        long max = 9_999_999_999_999_999L;
        String random16DigitNumber = "";
        boolean flag = true;
        while (flag) {
            random16DigitNumber = Long.toString(ThreadLocalRandom.current().nextLong(min, max + 1));
